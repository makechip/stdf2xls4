...
public final class PinTestID implements Identity, Immutable 
{
    ...
    private PinTestID(long testNum, String testName)
    {
    ...
    private PinTestID(long testNum, String testName, int dupNum)
    {
        this.testNum = testNum;
        this.testName = testName;
        this.dupNum = dupNum;
    ...
    private PinTestID(PinTestID id, String pin)
    {
    ...
    public static PinTestID getTestID(Ilong testNum, String testName, int dupNum)
    {
    	return(map2.getValue(testNum, testName, dupNum));
    }
    
    public static PinTestID getTestID(long testNum, String testName)
    {
    	PinTestID id = map1.get(testName);
    	if (id != null)
    	{
    		if (id.getTestNumber() == testNum) return(id);
    		return(map2.getValue(testNum, testName, 0));
    	}
    	id = new PinTestID(testNum, testName);
    	map1.put(testName, id);
        return(id);
    }
    
    public static PinTestID getTestID(PinTestID id, String pin)
    {
        return(pmap.getValue(id, pin));
    }
    
    public static PinTestID findTestID(long testNum, String testName)
    {
    	return(map2.getExistingValue(testNum, testName, 0));
    }
    
    public static PinTestID findTestID(long testNum, String testName, int dupNum)
    {
    	return(map2.getExistingValue(testNum, testName, dupNum));
    }
    
    public static PinTestID findTestID(PinTestID id, String pin)
    {
