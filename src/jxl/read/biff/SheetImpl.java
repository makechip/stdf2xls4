...
public class SheetImpl implements Sheet
{
   ...
   * page
   */
  private ArrayList<DrawingGroupObject> images;
    ...
    throws BiffException
  {
    ...
    sheetBof = sb;
    workbookBof = wb;
    columnInfosArray = new ArrayList<Object>();
    sharedFormulas = new ArrayList<Object>();
    hyperlinks = new ArrayList<Object>();
    rowProperties = new ArrayList<Object>(10);
...
public CellView getRowView(int row)
  ...
  private void initializeImages()
  {
    ...
    images = new ArrayList<DrawingGroupObject>();
  ...
  void addLocalName(NameRecord nr)
  {
    if (localNames == null)
    {
      localNames = new ArrayList<NameRecord>();
    }
