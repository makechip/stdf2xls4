  ...
  implements ExternalSheet, WorkbookMethods
{
   ...
   */
  private ArrayList<BoundsheetRecord> boundsheets;
  /**
   * The xf records
   */
   ...
   */
  private HashMap<String, NameRecord> namedRecords;

  /**
   * The list of named records
   */
  private ArrayList<NameRecord> nameTable;

  /**
   * The list of add in functions
   */
  private ArrayList<String> addInFunctions;
  ...
  private ArrayList<XCTRecord> xctRecords;
  ...
  public WorkbookParser(File f, WorkbookSettings s)
  {
    super();
    excelFile = f;
    boundsheets = new ArrayList<BoundsheetRecord>(10);
    fonts = new Fonts();
    formattingRecords = new FormattingRecords(fonts);
    sheets = new ArrayList<Sheet>(10);
    supbooks = new ArrayList<SupbookRecord>(10);
    namedRecords = new HashMap<String, NameRecord>();
    lastSheetIndex = -1;
    wbProtected = false;
    containsMacros = false;
    settings = s;
    xctRecords = new ArrayList<XCTRecord>(10);
  }
 ...
 /**
  ...
  protected void parse() throws BiffException, PasswordException
  {
    ...
    ArrayList<NameRecord> localNames = new ArrayList<NameRecord>();
    nameTable = new ArrayList<NameRecord>();
    addInFunctions = new ArrayList<String>();
    ...
    for (Iterator<NameRecord> it = localNames.iterator() ; it.hasNext() ;)
    {
