...
final class SheetReader
{
   ...
   */
  private ArrayList<HyperlinkRecord> hyperlinks;
              ...
              SheetImpl sh)
  {
    ...
    sheetBof = sb;
    workbookBof = wb;
    columnInfosArray = new ArrayList<ColumnInfoRecord>();
    sharedFormulas = new ArrayList<SharedFormulaRecord>();
    hyperlinks = new ArrayList<HyperlinkRecord>();
    conditionalFormats = new ArrayList<ConditionalFormat>();
    rowProperties = new ArrayList<RowRecord>(10);
    charts = new ArrayList<Chart>();
    drawings = new ArrayList<DrawingGroupObject>();
    outOfBoundsCells = new ArrayList<Cell>();
    nineteenFour = nf;
    workbook = wp;
    startPosition = sp;
    sheet = sh;
...
final void read()
  {
    ...
    Iterator<SharedFormulaRecord> i = sharedFormulas.iterator();
   ...
   */
  final ArrayList<HyperlinkRecord> getHyperlinks()
  {
    return hyperlinks;
  }
...
private void handleObjectRecord(ObjRecord objRecord,
  ...
  private void handleOutOfBoundsCells()
  {
    ...
    for (Iterator<Cell> i = outOfBoundsCells.iterator() ; i.hasNext() ;)
    {
