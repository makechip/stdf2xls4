...
private ArrayList<?> toColumnBreaks;
  ...
  private ArrayList<WritableImage> toDrawings;
...
private int numRows;
  ...
  void setColumnFormats(TreeSet<?> fcf, TreeSet<ColumnInfoRecord> tcf)
  {
  ...
  void setDrawings(ArrayList<?> fd, ArrayList<WritableImage> td, ArrayList<WritableImage> ti)
  {
    fromDrawings = fd;
    toDrawings = td;
    toImages = ti;
  ...
  void setHyperlinks(ArrayList<?> fh, ArrayList<WritableHyperlink> th)
  {
    fromHyperlinks = fh;
    toHyperlinks = th;
  }
  ...
  public void copySheet()
  {
    ...
    toRowBreaks = new ArrayList<Object>(fromRowBreaks);

    // Copy the vertical page breaks
    toColumnBreaks = new ArrayList<Object>(fromColumnBreaks);
