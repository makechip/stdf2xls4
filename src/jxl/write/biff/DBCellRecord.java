...
class DBCellRecord extends WritableRecordData
{
   ...
   */
  private ArrayList<Integer> cellRowPositions;
  ...
  public DBCellRecord(int rp)
  {
    super(Type.DBCELL);
    rowPos = rp;
    cellRowPositions = new ArrayList<Integer>(10);
  }
  ...
  protected byte[] getData()
  {
    ...
    Iterator<Integer> i = cellRowPositions.iterator();
    while (i.hasNext())
    {
      int cellPos = i.next().intValue();
