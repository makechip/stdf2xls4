...
final class CompoundFile extends BaseCompoundFile
{
    ...
    throws CopyAdditionalPropertySetsException, IOException
  {
    ...
    additionalPropertySets = new ArrayList<ReadPropertyStorage>();
    standardPropertySets = new HashMap<String, ReadPropertyStorage>();
  ...
  private void writeAdditionalPropertySets() throws IOException
  {
    ...
    for (Iterator<ReadPropertyStorage> i = additionalPropertySets.iterator(); i.hasNext() ;)
    {
