  ...
  implements ExternalSheet, WorkbookMethods
{
   ...
   */
  private HashMap<Object, NameRecord> nameRecords;
    ...
    throws IOException
  {
    ...
    nameRecords = new HashMap<Object, NameRecord>();
    closeStream = cs;
    wbProtected = false;
    containsMacros = false;
    settings = ws;
    rcirCells = new ArrayList<CellValue>();
    styles = new Styles();
                              ...
                              WorkbookSettings ws) throws IOException
  {
    ...
    if (wp.getExternalSheetRecord() != null)
    {
      ...
      supbooks = new ArrayList<SupbookRecord>(readsr.length);
    ...
    if (!settings.getNamesDisabled())
    {
      ...
      names = new ArrayList<NameRecord>(na.length);
  ...
  public WritableSheet getSheet(String name)
  {
    ...
    boolean found = false;
    Iterator<WritableSheet> i = sheets.iterator();
  ...
  public WritableSheet moveSheet(int fromIndex, int toIndex)
  {
    ...
    WritableSheet sheet= sheets.remove(fromIndex);
  ...
  public int getExternalSheetIndex(String sheetName)
  {
    if (externSheet == null)
    {
      ...
      supbooks = new ArrayList<SupbookRecord>();
  ...
  void columnInserted(WritableSheetImpl s, int col)
  {
    ...
    for (Iterator<CellValue> i = rcirCells.iterator() ; i.hasNext() ;)
    {
      CellValue cv = i.next();
    ...
    if (names != null)
    {
      for (Iterator<NameRecord> i = names.iterator(); i.hasNext() ;)
      {
        NameRecord nameRecord = i.next();
  ...
  void columnRemoved(WritableSheetImpl s, int col)
  {
    ...
    // Adjust any named cells
    ArrayList<NameRecord> removedNames = new ArrayList<NameRecord>();
    if (names != null)
    {
      for (Iterator<NameRecord> i = names.iterator(); i.hasNext() ;)
      {
      ...
      for (Iterator<NameRecord> i = removedNames.iterator(); i.hasNext() ;)
      {
        NameRecord nameRecord = i.next();
