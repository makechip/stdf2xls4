...
public class ConditionalFormat
{
   ...
   */
  private ArrayList<ConditionalFormatRecord> conditions;
  ...
  {
    range = cfrr;
    conditions = new ArrayList<ConditionalFormatRecord>();
  }
  ...
  public void write(File outputFile) throws IOException
  {
    ...
    for (Iterator<ConditionalFormatRecord> i = conditions.iterator(); i.hasNext();)
    {
