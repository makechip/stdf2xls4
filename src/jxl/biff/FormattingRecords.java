...
public class FormattingRecords
{
   ...
   * in a spreadsheet
   */
  private HashMap<Integer, DisplayFormat> formats;

  /**
   * A list of formats, used when writing out a spreadsheet
   */
  private ArrayList<Object> formatsList;

  /**
   * The list of extended format records
   */
  private ArrayList<Object> xfRecords;
  ...
  {
    xfRecords = new ArrayList<Object>(10);
    formats = new HashMap<Integer, DisplayFormat>(10);
    formatsList = new ArrayList<Object>(10);
    fonts = f;
...
FormatRecord getFormatRecord(int index)
  ...
  public void write(File outputFile) throws IOException
  {
    ...
    Iterator<Object> i = formatsList.iterator();
                                  ...
                                  IndexMapping formatMapping)
  {
    ...
    // at the same time
    XFRecord xfr = null;
    for (Iterator<Object> it = xfRecords.iterator(); it.hasNext();)
    {
    ...
    ArrayList<Object> newrecords = new ArrayList<Object>(minXFRecords);
    ...
    for (int i = minXFRecords; i < xfRecords.size(); i++)
    {
      ...
      for (Iterator<Object> it = newrecords.iterator();
    ...
    for (Iterator<Object> i = xfRecords.iterator(); i.hasNext();)
    {
  ...
  {
    ArrayList<Object> newformats = new ArrayList<Object>();
    int numremoved = 0;
    ...
    while (i.hasNext())
    {
      ...
      // Compare against formats already on the list
      Iterator<Object> i2 = newformats.iterator();
      duplicate = false;
