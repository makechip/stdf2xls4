...
public class NDC {
  ...
  static Hashtable<Thread, Stack<DiagnosticContext>> ht = new Hashtable<Thread, Stack<DiagnosticContext>>();
   ...
   */
  private static Stack<DiagnosticContext> getCurrentStack() {
      if (ht != null) {
          return (Stack<DiagnosticContext>) ht.get(Thread.currentThread());
      }
      return null;
  }
  ...
  static
  void clear() {
    Stack<DiagnosticContext> stack = getCurrentStack();    
    if(stack != null) 
      stack.setSize(0);    
  }
...
public
  static
  Stack<DiagnosticContext> cloneStack() {
    Stack<DiagnosticContext> stack = getCurrentStack();
    if(stack == null)
      return null;
    else {
      return (Stack<DiagnosticContext>) stack.clone();
    }
  }
  ...
  */
  public
  static
  void inherit(Stack<DiagnosticContext> stack) {
    if(stack != null)
  ...
  */
  ...
  public
  String get() {
    Stack<DiagnosticContext> s = getCurrentStack();
    if(s != null && !s.isEmpty()) 
  ...
  void lazyRemove() {
	...
	pushCounter = 0; // OK let's do some work.
      ...
      int misses = 0;
      v = new Vector<Thread>(); 
      Enumeration<Thread> enumeration = ht.keys();
