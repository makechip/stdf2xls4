...
public class PropertyConfigurator implements Configurator {
   ...
   */
  protected Hashtable<String, Appender> registry = new Hashtable<String, Appender>(11);  
...
Appender parseAppender(Properties props, String appenderName) {
  ...
  void parseAppenderFilters(Properties props, String appenderName, Appender appender) {
    ...
    Hashtable<String, Vector<NameValue>> filters = new Hashtable<String, Vector<NameValue>>();
    ...
    while (e.hasMoreElements()) {
      ...
      if (key.startsWith(filterPrefix)) {
        ...
        Vector<NameValue> filterOpts = (Vector<NameValue>) filters.get(filterKey);
        if (filterOpts == null) {
...
class SortedKeyEnumeration implements Enumeration<Object> {

  private Enumeration<String> e;

  public SortedKeyEnumeration(Hashtable<String, Vector<NameValue>> ht) {
