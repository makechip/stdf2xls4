...
public class FilteredLogTableModel
  ...
  /**
     * 
     */
    private static final long serialVersionUID = -8992671089131499904L;
protected LogRecordFilter _filter = new PassingLogRecordFilter();
  protected List<LogRecord> _allRecords = new ArrayList<LogRecord>();
  ...
  protected List<LogRecord> createFilteredRecordsList() {
    ...
    Iterator<LogRecord> records = _allRecords.iterator();
    LogRecord current;
  ...
  protected LogRecord getFilteredRecord(int row) {
    List<LogRecord> records = getFilteredRecords();
