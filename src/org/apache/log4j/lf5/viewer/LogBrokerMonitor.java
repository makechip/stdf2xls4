...
//    public static final String COMPACT_VIEW = "Compact";
  ...
  protected JComboBox<String> _fontSizeCombo;
  ...
  protected List<Object> _displayedLogBrokerProperties = new Vector<Object>();

  protected Map<LogLevel, JCheckBoxMenuItem> _logLevelMenuItems = new HashMap<LogLevel, JCheckBoxMenuItem>();
  protected Map<LogTableColumn, JCheckBoxMenuItem> _logTableColumnMenuItems = new HashMap<LogTableColumn, JCheckBoxMenuItem>();
  ...
  public Map<LogLevel, JCheckBoxMenuItem> getLogLevelMenuItems() {
    return _logLevelMenuItems;
  }

  public Map<LogTableColumn, JCheckBoxMenuItem> getLogTableColumnMenuItems() {
   ...
   */
  protected int changeFontSizeCombo(JComboBox<String> box, int requestedSize) {
  ...
  protected JCheckBoxMenuItem createLogTableColumnMenuItem(LogTableColumn column) {
    ...
    result.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        List<LogTableColumn> selectedColumns = updateView();
...
protected JToolBar createToolBar() {
    ...
    JComboBox<String> fontSizeCombo = new JComboBox<String>();
