...
public class LogLevel implements java.io.Serializable {
  ...
  /**
     * 
     */
    private static final long serialVersionUID = 5251735053323350105L;
// log4j log levels.
  ...
  private static Map<LogLevel, Color> _logLevelColorMap;
  private static Map<String, LogLevel> _registeredLogLevelMap = new HashMap<String, LogLevel>();
  ...
  static {
    ...
    _logLevelMap = new HashMap<String, LogLevel>();
    ...
    _logLevelColorMap = new HashMap<LogLevel, Color>();
    for (int i = 0; i < _allDefaultLevels.length; i++) {
   ...
   */
  public static List<LogLevel> getLog4JLevels() {
    return Arrays.asList(_log4JLevels);
  }

  public static List<LogLevel> getJdk14Levels() {
    return Arrays.asList(_jdk14Levels);
  }

  public static List<LogLevel> getAllDefaultLevels() {
    return Arrays.asList(_allDefaultLevels);
  }

  public static Map<LogLevel, Color> getLogLevelColorMap() {
