...
public class LayoutDynamicMBean extends AbstractDynamicMBean {
  ...
  private Vector<MBeanAttributeInfo> dAttributes = new Vector<MBeanAttributeInfo>();
  private String dClassName = this.getClass().getName();

  private Hashtable<String, MethodUnion> dynamicProps = new Hashtable<String, MethodUnion>(5);
