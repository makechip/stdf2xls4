...
public class LoggingEvent implements java.io.Serializable {
  ...
  private Hashtable<String, String> mdcCopy;
...
static final Class[] TO_LEVEL_PARAMS = new Class[] {int.class};
  static final Hashtable<String, Method> methodCache = new Hashtable<String, Method>(3); // use a tiny table
...
public
  void getMDCCopy() {
    if(mdcCopyLookupRequired) {
      ...
      // See also bug #5932.
      Hashtable<String, String> t = (Hashtable<String, String>) MDC.getContext();
      if(t != null) {
	mdcCopy = (Hashtable<String, String>) t.clone();
      }
    }
  }
  ...
  */
  ...
  void writeLevel(ObjectOutputStream oos) throws java.io.IOException {
    ...
    Class<? extends Priority> clazz = level.getClass();
  ...
  public final void setProperty(final String propName,
        ...
        if (mdcCopy == null) {
            mdcCopy = new Hashtable<String, String>();
        }
